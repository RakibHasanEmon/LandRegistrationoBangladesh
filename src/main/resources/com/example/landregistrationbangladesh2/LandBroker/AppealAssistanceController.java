...
public class AppealAssistanceController {
    @FXML
    ...
    private void handleEvent1() {
        System.out.println("Analyze Rejection Reason triggered.");
    }

    private void handleEvent2() {
        System.out.println("Collect Appeal Documents triggered.");
    }

    private void handleEvent3() {
        System.out.println("Draft Appeal Petition triggered.");
    }

    private void handleEvent4() {
        System.out.println("Submit Appeal triggered.");
    }

    private void handleEvent5() {
        System.out.println("Represent in Appeal Hearing triggered.");
    }
